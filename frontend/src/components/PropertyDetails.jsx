...
const PropertyDetails = ({
  ...
  // Rent condition for showing image upload button
  const isHighRent = property.rent > 10000;
      ...
      <div className="mb-8">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {property.amenities &&
           ...
           {/* Image upload button when rent exceeds 10000 */}
        {isHighRent && (
          <div className="flex items-center gap-3 mt-4 md:mt-0 md:ml-6">
            <div>
              <label
                htmlFor="imageUpload"
                className="cursor-pointer rounded-lg bg-blue-500 p-3 text-white hover:bg-blue-600"
              >
                Upload Income Proof
              </label>
              <input
