...
const storage = multer.diskStorage({
  ...
  filename: (req, file, cb) => {
    cb(null, Date.now() + '-' + file.originalname); // Use current time as a unique identifier
  }
});
...
const requestSchema = new Schema(
  {
    ...
    file: {  // Added field for storing file reference
      type: String, // You can change this to another type if storing multiple files or in a different storage solution.
      default: null,
    },
  },
  {
